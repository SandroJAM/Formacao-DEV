...
export default function ProdutoItem(props: ProdutoItemProps) {
    ...
    return (<Link href={`/produto/${produto.id}`}
        className="flex flex-col bg-violet-dark border border-white/30 rounded-xl relative max-w-[350px]"
    >
        ...
        <div className="flex-1 flex flex-col p-5 gap-3 border-t border-white/30">
